        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-left">
          <div className="max-w-3xl">
            ...
            <h1 className="text-5xl md:text-7xl font-bold mb-8 leading-tight">
              Strategic AI <span className="text-blue-400">Product Advisory</span>
            </h1>
          ...
          <div className="grid lg:grid-cols-2 gap-20">
            <div>
              <h2 className="text-3xl font-bold mb-12 flex items-center gap-4 text-slate-900">
                <span className="w-12 h-1.5 bg-blue-600 rounded-full inline-block"></span>
                Consulting Pillars
              </h2>
              <div className="space-y-16">
                {[
                  ...
                  <div key={idx} className="group">
                    <h3 className="text-2xl font-bold mb-4 text-slate-900 group-hover:text-blue-600 transition-colors">{pillar.title}</h3>
            ...
            <div className="relative">
              <div className="sticky top-32 bg-slate-950 rounded-[3rem] p-12 text-white overflow-hidden shadow-2xl">
                <div className="absolute top-0 right-0 p-12 opacity-5">
                  <svg className="w-48 h-48" fill="currentColor" viewBox="0 0 24 24"><path d="M13 10V3L4 14H11V21L20 10H13Z"/></svg>
                </div>
                <h3 className="text-3xl font-bold mb-8">The "Moonspring" Sprint</h3>
                ...
                <div className="space-y-8">
                  {[
                    ...
                    <div key={i} className="flex items-center gap-8 border-b border-white/5 pb-6 last:border-0">
                      <span className="text-blue-400 font-mono font-bold text-xl">W{step.week}</span>
                ...
                <button 
                  ...
                  className="w-full mt-12 bg-blue-600 py-5 rounded-2xl font-bold hover:bg-blue-500 transition-all shadow-xl shadow-blue-900/40 text-lg"
                >
